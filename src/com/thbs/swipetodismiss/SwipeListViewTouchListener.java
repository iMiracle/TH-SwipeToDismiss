...
public class SwipeListViewTouchListener implements View.OnTouchListener {
	...
	public static boolean testRight = false;
	public static boolean testLeft = false;
	 ...
	 * 
	 * @param listView
	 *            The list view whose items should be dismissible.
	 * @param callback
	 *            The callback to trigger when the user has indicated that she
	 *            would like to dismiss one or more list items.
	 * @param dismissLeft
	...
	public boolean onTouch(View view, MotionEvent motionEvent) {
		...
		case MotionEvent.ACTION_UP: {
			...
			mVelocityTracker.addMovement(motionEvent);
			mVelocityTracker.computeCurrentVelocity(1); // 1000 by default but
														// higher values can
		...
		case MotionEvent.ACTION_MOVE: {
			...
			if (mSwiping) {
				mDownView.setBackgroundColor(Color.TRANSPARENT);// Set your own
																// color
				mDownView.setTranslationX(deltaX);

				if (deltaX > 20) {
					mDownView.setBackgroundColor(Color.GREEN);// Set your own
																// color
				}

				else if (deltaX < -20) {

					mDownView.setBackgroundColor(Color.RED);// Set your own
															// color
	...
	private void performSwipeAction(final View swipeView,
		...
		// frame; in the future we may want to do something smarter.
